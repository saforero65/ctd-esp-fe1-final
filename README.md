...
- La aplicación deberá contar con dos páginas:
  ...
  1 - La página de inicio que debe contar con:
          ...
          * Panel de filtros:
            * Contendrá un input en donde el usuario pueda ingresar cualquier texto que desee para hacer un filtro sobre los personajes (characters).
...
- [src/componentes/layout/encabezado.componente.jsx](src/componentes/layout/encabezado.componente.jsx) - Encabezado requerido para cada una de las páginas. Facilita la navegación. (Se reemplazo por: src/components/layout/header.component.jsx)

- [src/componentes/personajes/filtros.componente.tsx](src/componentes/personajes/filtros.componente.tsx) - Componente con el input text para realizar el filtrado. (Se reemplazo por: src/components/characters/filters.component.jsx)

- [src/componentes/personajes/grilla-personajes.componente.jsx](src/componentes/personajes/grilla-personajes.componente.jsx) - Grilla de personajes para la pagina de inicio. (Se reemplazo por: src/components/characters/grid-characters.component.jsx)

- [src/componentes/personajes/tarjeta-personaje.componente.tsx](src/componentes/personajes/tarjeta-personaje.componente.tsx) - Tarjeta para cada personaje dentro de la grilla de personajes. (Se reemplazo por: src/components/characters/card-character.component.jsx)

- [src/componentes/botones/boton-favorito.componente.jsx](src/componentes/botones/boton-favorito.componente.jsx) - Boton que indica si un elemento es favorito o no, y da la posibilidad de marcarlo/desmarcarlo. (Se reemplazo por: src/components/buttons/button-favorite.component.jsx)

- [src/componentes/episodios/tarjeta-episodio.componente.tsx](src/componentes/episodios/tarjeta-episodio.componente.tsx) - Tarjeta para cada episodio dentro de la vista de personaje. (Se reemplazo por: src/components/episodes/card-episode.component.jsx)
